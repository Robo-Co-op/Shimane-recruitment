...
<div class="box">
  <div class="lang-tog">
    <a href="/admin/accept-invite?token=<?= urlencode($token) ?>&amp;setlang=en" class="lt-btn <?= $lang==='en'?'on':'' ?>">EN</a>
    <a href="/admin/accept-invite?token=<?= urlencode($token) ?>&amp;setlang=ja" class="lt-btn <?= $lang==='ja'?'on':'' ?>">日本語</a>
  </div>
  <div class="logo">
