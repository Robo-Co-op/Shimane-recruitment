    ...
    <div class="form-card">
      <form method="POST" action="/apply/" id="app-form" novalidate>
        ...
        <div style="text-align:center; padding: 0 32px 20px;">
          <button type="button" id="btn-save" onclick="saveAndShowLink()" style="background:none;border:none;color:var(--mint-dark);font-size:13px;cursor:pointer;text-decoration:underline;padding:4px 0">💾 Save progress and come back later</button>
          <div id="save-msg" style="display:none;margin-top:8px;padding:10px 14px;background:#F0FAF8;border:1px solid var(--mint);border-radius:8px;font-size:13px;text-align:left">
            ✅ Saved! Bookmark or copy this link to continue later:<br>
...
<script>
  ...
  async function saveAndShowLink() {
    ...
    if (!draftToken) { alert('Could not save your progress. Please try again.'); return; }
